...
namespace Cinemachine
{
    ...
    [ExecuteInEditMode]
#endif
    public class CinemachineColliderFollow : CinemachineExtension
    {
            ...
            CinemachineCore.Stage stage, ref CameraState state, float deltaTime)
        {
            ...
            if (stage == CinemachineCore.Stage.Body) {
                if (m_AvoidObstacles) {
                    ...
                    displacement = PreserveLineOfFollow(vcam, ref state, ref extra);
        ...
        //My function
        private Vector3 PreserveLineOfFollow(CinemachineVirtualCameraBase vcam, ref CameraState state, ref VcamExtraState extra)
        {
            Vector3 displacement = Vector3.zero;
            if (state.HasLookAt && m_CollideAgainst != 0
                ...
                if (hitInfo.collider != null) {
                    ...
                    if (m_Strategy != ResolutionStrategy.PullCameraForward) {
                        ...
                        pos = PushCameraBack(
                            pos, targetToCamera, hitInfo, followPos,
